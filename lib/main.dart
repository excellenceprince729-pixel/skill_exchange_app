  ...
  Future<void> initialize() async {
    ...
    _skills = [
      Skill(
        ...
        description:
            'Learn to build cross-platform mobile apps with Flutter and Dart. Perfect for beginners and intermediate developers.',
      ...
      Skill(
        ...
        description:
            'Beginner to advanced guitar techniques. Learn chords, scales, fingerstyle, and music theory.',
        category: 'Music',
        userId: '2',
        userName: 'Jane Smith',
        rating: 4.9,
      ...
      Skill(
        ...
        description:
            'Conversational Spanish for beginners. Focus on practical communication and cultural understanding.',
        category: 'Language',
        userId: '3',
      ...
      Skill(
        ...
        description:
            'Learn the fundamentals of photography including composition, lighting, and camera settings.',
        category: 'Art',
        userId: '2',
        userName: 'Jane Smith',
        rating: 4.6,
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [const Color(0xFF6C63FF), const Color(0xFF36D1DC)],
                  ),
        ...
        child: ListView(
          ...
          children: [
            _buildNotificationCard(
              ...
              message:
                  'Your Flutter Development lesson is confirmed for tomorrow.',
              time: '2 hours ago',
              color: Colors.green,
            ),
            const SizedBox(height: 12),
                  ...
                  Row(
                    children: [
                      _buildInfoCard(
                        ...
                        color: skill.isAvailable ? Colors.green : Colors.orange,
                      ),
                      const SizedBox(width: 16),
                      _buildInfoCard(
                        icon: Icons.category,
